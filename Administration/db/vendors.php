    ...
    <tr>
      ...
      <td valign="top" width="165" bgcolor="#cccc99"><img height="1" alt="" src="../../images/asybase.gif" width="145" border="0"> <br>
          <table width="100%" border="0" cellspacing="0" cellpadding="1" rules="rows">
            <tr>
              <td class="mainsection"><a href="controller.php" class="dark">Contollers</a></td>
            </tr>
          </table>
          <table width="100%" border="0" cellspacing="0" cellpadding="1" rules="rows">
            <tr>
              <td class="mainsection"><a href="vendors.php" class="dark">AS/400-Vendors</a></td>
            </tr>
        </table>
          <table width="100%" border="0" cellspacing="0" cellpadding="1" rules="rows">
            <tr>
              <td class="mainsection">Preferred Vendor </td>
            </tr>
          </table></td>
...
<!-- #EndLibraryItem --></td>
    <td align="center" valign="top"><table border="0" cellspacing="0" cellpadding="0">
		<tr><td>&nbsp;</td></tr>
        <tr>
          <td height="30" class="BGAccentVeryDark">&nbsp;<strong>Vendor List Controls</strong></td>
        </tr>
        <tr>
          <td class="BGAccentVeryDarkBorder"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td height="30">Complete Update:&nbsp;</td>
                <td><a href="../../cron/vendor.php?t=full&b=off&html=on"><img src="../../images/button.php?i=b90.png&l=Run Update" border="0"></a></td>
              </tr>
              <tr>
                <td height="30">Hourly Update:</td>
                <td><a href="../../cron/vendor.php?t=hourly"><img src="../../images/button.php?i=b90.png&l=Run Update" border="0"></a></td>
              </tr>
          </table></td>
        </tr>
        <tr>
    ...
    <td width="400" align="center" valign="top"><br>
      ...
      <?php if ($handle = opendir($default['UPLOAD'])) { ?>
      <tr>
        <td class="BGAccentVeryDark" height="10"><table width="100%" height="10" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="10" height="10" valign="top"><img src="../../images/menu_top_left.gif" width="10" height="10"></td>
              <td align="center"><span class="ColorHeaderSubSub">Vendor Backup List</span> </td>
      ...
      <tr>
        <td class="BGAccentVeryDarkBorder"><table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="xpHeaderTop">Database</td>
              <td class="xpHeaderTop">Table</td>
              <td class="xpHeaderTop">Date</td>
              <td class="xpHeaderTop">Size</td>
            </tr>
            <?php
				...
				while (false !== ($filename = readdir($handle))) {
					...
					$file = $default['UPLOAD'] . "/" . $filename;
					
					list($database, $table, $date) = split('_', $filename);
			  ?>
            <tr <?php pointer($row_color); ?>>
              <td class="padding" bgcolor="#<?= $row_color; ?>"><a href="<?= $default['URL_UPLOAD']."/".$filename; ?>" class="dark"><?= $database; ?></a></td>
              <td class="padding" bgcolor="#<?= $row_color; ?>"><a href="<?= $default['URL_UPLOAD']."/".$filename; ?>" class="dark"><?= $table; ?></a></td>
              <td nowrap bgcolor="#<?= $row_color; ?>" class="padding"><a href="<?= $default['URL_UPLOAD']."/".$filename; ?>" class="dark"><?= date("M d Y", filectime($file)); ?></a></td>
              <td align="right" class="padding" bgcolor="#<?= $row_color; ?>"><?= getfilesize(filesize($file)); ?></td>
            </tr>
            <?php
				}
      ...
      <tr>
        <td height="10" class="BGAccentVeryDark"><table width="100%" height="10" border="0" cellpadding="0" cellspacing="0">
            <tr>
