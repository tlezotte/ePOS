    ...
    <tr>
      ...
      <td valign="top" width="165" bgcolor="#cccc99"><img height="1" alt="" src="/Common/images/asybase.gif" width="145" border="0"> <br>
          <table width="100%" border="0" cellspacing="0" cellpadding="1" rules="rows">
            <tr>
              <td class="mainsection"><a href="db/controller.php" title="Controller List" class="dark" rel="gb_page_fs[]">Controller List</a> </td>
            </tr>
          </table>
          <table width="100%" border="0" cellspacing="0" cellpadding="1" rules="rows">
            <tr>
              <td class="mainsection"><a href="db/role.php" title="Users Role List" class="dark" rel="gb_page_fs[]">Users Role List</a> </td>
            </tr>
          </table>
		  <!--
          <table width="100%" border="0" cellspacing="0" cellpadding="1" rules="rows">
