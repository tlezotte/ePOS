 ...
 * Request System
 *
 * updateRSS.php force RSS feed to reprocess.
 *
 * @version 1.5
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td height="30" nowrap class=
                                  "DarkHeaderSubSub">&nbsp;&nbsp;Update RSS...</td>
                          ...
                          <tr>
                            <td class="BGAccentDarkBorder"><table width="100%"  border="0">
                                <tr class="BGAccentLight">
                                  <td height="25"><a href="../CER/rss.php"><img src="../images/button.php?i=b150.png&l=Capital Expenses" border="0" align="absmiddle"></a></td>
                                </tr>
                                <tr class="BGAccentLight">
                                  <td>
                                    <div align="left"><a href="../PO/rss.php"><img src="../images/button.php?i=b150.png&l=Purchase Orders" border="0" align="absmiddle"></a></div></td></tr>
                            </table></td>
                          </tr>
                      </table></td>
                    </tr>
