                  ...
                  <div align="right">
                    <table  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td valign="top">&nbsp;
                            <input name="addUserButton" type="image" id="addUserButton" src="../images/button.php?i=b110.png&l=Add User" align="bottom" border="0">
              ...
              <td class="BGAccentVeryDarkBorder"><table  border="0" cellspacing="0" cellpadding="0">
				  ...
				  ?>
                        <tr <?php pointer($row_color); ?>>
                          <td nowrap bgcolor="#<?= $row_color; ?>"><a href="forgotPassword.php?action=process&eid=<?= $USERS['eid']; ?>" <?php help('', 'Pick email icon to send '.ucwords(strtolower($USERS['fst']." ".$USERS['lst'])).' their username and password', 'default'); ?>><img src="/Common/images/resend_email.gif" width="19" height="16" border="0" align="absmiddle"></a>
						<?php if ($_SESSION['request_access'] == '3') { ?>
						...
						<?php } ?>						  
						  <a href="user_details.php?eid=<?= $USERS['eid']; ?>" <?php if ($USERS['eid'] != '08745') { ?> onMouseover="return overlib('Username: <?= $USERS['username']; ?><br>Password: <?= $USERS['password']; ?><br>EID: <?= $USERS['eid']; ?><br>Email: <?= $USERS['email']; ?><br>Phone: <?= $USERS['phn']; ?>', WRAP, CAPTION, 'User Information');" onMouseout="return nd();" <?php } ?> class="black" rel="gb_page_center[425, 350]">
