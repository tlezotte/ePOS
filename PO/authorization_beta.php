...
if ($_POST['stage'] == "three") {
	...
	$_SESSION['issuer'] = htmlentities($_POST['issuer'], ENT_QUOTES, 'UTF-8');
                        ...
                        <tr>
                          <td colspan="9"><table width="100%"  border="0">
                              <tr>
                                ...
                                <td width="25%"><div align="center" class="wizardPast">Items</div></td>
                                <td width="25%"><div align="center" class="wizardCurrent">Authorization</div></td>
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td><table border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td class="BGAccentVeryDark"><div align="left">
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td height="30" nowrap class="DarkHeaderSubSub">&nbsp;&nbsp;<strong><img src="../images/checkmark.gif" width="16" height="16" align="texttop"></strong>&nbsp;Authorization...</td>
                              ...
                              <tr>
                                <td class="BGAccentVeryDarkBorder"><table width="100%"  border="0" cellspacing="3">
                                    <tr>
                                    ...
                                    <tr>
                                      ...
                                      <td><select name="app3" id="app3">
										  ...
										  while($app3_sth->fetchInto($APP3)) {
											...
											print "<option value=\"".$APP3[eid]."\" ".$selected.">".ucwords(strtolower($APP3[lst].", ".$APP3[fst]))."</option>";
										  }
										  ?>
                                        </select>
										  <?php if ($_SESSION['total'] > $default['app3_min']) { ?>
                                          <vlvalidator name="app3" type="compare" control="app3" errmsg="Approver 3 is required for requests above $<?= $default['app3_min']; ?> and $<?= $default['app3_max']; ?>." validtype="string" comparevalue="0" comparecontrol="app3" operator="ne">
									  <?php } ?></td>
                                    </tr>
                                    <tr>
                                      ...
                                      <td><select name="app4" id="app4">
										  ...
										  <?php if ($_SESSION['total'] > $default['app4_min']) { ?>
                                          <vlvalidator name="app4" type="compare" control="app4" errmsg="Approver 4 is required for requests above $<?= $default['app4_max']; ?>." validtype="string" comparevalue="0" comparecontrol="app4" operator="ne">
									  <?php } ?></td>
                                    </tr>
                              ...
                              <tr>
                                <td><div align="right">
                                    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td>&nbsp;<a href="items_beta.php"><img src="../images/button.php?i=b70.png&l=Back" border="0"></a></td>
                                        <td><div align="right">
                                            <input name="stage" type="hidden" id="stage" value="three">
                                            <input name="done" type="image" id="done" src="../images/button.php?i=b70.png&l=Done" class="button" border="0">
                                          &nbsp;</div></td>
                                      </tr>
                                    </table>
                                </div></td>
                          ...
                          <tr>
                            <td class="BGAccentDarkBorder" style="padding:10px"> Approver 1 is required for all requisitions.<br>
                              Approver 2 is required for requisitions between $
      <?= number_format($default['app2_min'],2); ?>
                              and $
                              <?= number_format($default['app2_max'],2); ?>.<br>
                              Approver 3 is required for requisitions between $
                              <?= number_format($default['app3_min'],2); ?>
                              and $
                              <?= number_format($default['app3_max'],2); ?>.<br>
                              Approver 4 is required for requisitions above $
                              <?= number_format($default['app4_min'],2); ?>. </td>
                          </tr>
                        </table>
                    </form>			
                      <br>
