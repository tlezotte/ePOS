...
$contacts_sql="SELECT * FROM Contacts WHERE request_id=" . $PO['id'] . " AND status='0' ORDER BY id DESC";
$contacts_query=$dbh->prepare($contacts_sql);
$contacts_sth = $dbh->execute($contacts_query);
$contacts_count = $contacts_sth->numRows();
$contacts2_sql="SELECT * FROM Contacts WHERE request_id=" . $PO['id'] . " ORDER BY id DESC";
$contacts2_query=$dbh->prepare($contacts2_sql);
/* ------------- Get Contact Information Vendor List ------------- */
                                    ...
                                    <tr>
                                      <td><table width="100%" border="0" cellspacing="2" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                              <td class="blueNoteAreaBorder"><table border="0">
                                                ...
                                                <tr>
                                                  ...
                                                  <td align="center" class="label"><input name="cc_phone" type="text" id="cc_phone" size="12" maxlength="12" class="BGAccentDarkBlueBorder"></td>
												  <td class="label"><input name="cc_ext" type="text" id="cc_ext" size="10" maxlength="10" class="BGAccentDarkBlueBorder"></td>
                                                  <td align="center" class="label"><input name="cc_fax" type="text" id="cc_fax" size="12" maxlength="12" class="BGAccentDarkBlueBorder"></td>
                                                ...
                                                <?php
												while($contacts_sth->fetchInto($CONTACTS)) {
												?>
                                                <tr>
                                                  <td class="label"><?= $CONTACTS['name']; ?></td>
                                                  <td class="label"><?= str_format_number(str_replace($phone_char, '', $CONTACTS['phone']), $format_phone); ?></td>
												  <td class="label"><?= (empty($CONTACTS['ext'])) ? $blank : 'x'.$CONTACTS['ext']; ?></td>
                                                  <td class="label"><?= str_format_number(str_replace($phone_char, '', $CONTACTS['fax']), $format_phone); ?></td>
                                          ...
                                          <fieldset class="collapsed" id="sendPurchaseOrderF">
										  <legend><a href="javascript:switchFieldset('sendPurchaseOrder', 'collapsed');" id="sendPurchaseOrderA">Send Purchase Order</a></legend>
										  <table border="0" align="center" cellpadding="0" cellspacing="0" id="sendPurchaseOrder" style="display:display">
                                            <tr>
                                              <td class="blueNoteAreaBorder"><table border="0">
                                                <tr class="blueNoteArea">
                                                  <td class="label"><img src="/Common/images/gtk-no.gif" width="24" height="24"></td>
                                                  <td class="label">Name</td>
                                                  <td class="label">Phone</td>
												  <td class="label">Ext</td>
                                                  <td class="label">Fax</td>
                                                ...
                                                <tr>
                                                  <td class="label"><input name="cc_save" type="radio" value="no"></td>
                                                  <td class="label"><input name="cc_name" type="text" id="cc_name" size="30" maxlength="30" class="BGAccentDarkBlueBorder"></td>
                                                  <td align="center" class="label"><input name="cc_phone" type="text" id="cc_phone" size="12" maxlength="12" class="BGAccentDarkBlueBorder"></td>
												  <td class="label"><input name="cc_ext" type="text" id="cc_ext" size="10" maxlength="10" class="BGAccentDarkBlueBorder"></td>
                                                  <td align="center" class="label"><input name="cc_fax" type="text" id="cc_fax" size="12" maxlength="12" class="BGAccentDarkBlueBorder"></td>
												  <td align="right" class="label"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      <tr>
                                                        <td><input name="cc_email" type="text" id="cc_email" size="50" maxlength="50" class="BGAccentDarkBlueBorder"></td>
                                                        <td width="35" align="center"><input name="addContact" type="image" id="addContact" src="../images/add.gif"></td>
                                                      </tr>
                                                ...
                                                <?php
												$contacts2_sth = $dbh->execute($contacts2_query);
												while($contacts2_sth->fetchInto($CONTACTS2)) {
												?>
                                                <tr>
                                                  <td class="label">&nbsp;</td>
                                                  <td class="label"><?= $CONTACTS2['name']; ?></td>
                                                  <td class="label"><?= str_format_number(str_replace($phone_char, '', $CONTACTS2['phone']), $format_phone); ?></td>
												  <td class="label"><?= (empty($CONTACTS2['ext'])) ? $blank : 'x'.$CONTACTS2['ext']; ?></td>
                                                  <td class="label"><input name="send_fax[]" type="checkbox" id="send_fax" value="<?= str_format_number(str_replace($phone_char, '', $CONTACTS2['fax']), $format_phone); ?>" <?= (empty($CONTACTS2['fax'])) ? disabled : $blank; ?>><?= str_format_number(str_replace($phone_char, '', $CONTACTS2['fax']), $format_phone); ?></td>
												  <td class="label"><input name="send_email[]" type="checkbox" id="send_email" value="<?= $CONTACTS2['email']; ?>" <?= (empty($CONTACTS2['email'])) ? disabled : $blank; ?>><?= $CONTACTS2['email']; ?></td>
                                                </tr>
                                                <?php } ?>
                                              </table></td>
                                            </tr>
                                            <tr>
                                              <td height="30" align="right" valign="bottom"><input name="sendPO" id="sendPO" type="image" src="../images/button.php?i=w70.png&l=Send" alt="Send Purchase Order" border="0">
                                              &nbsp;</td>
                                            </tr>
                                          </table>
                                          </fieldset></td>
