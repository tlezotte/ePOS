...
$employees_sql = $dbh->prepare("SELECT eid, fst, lst 
								...
								WHERE status = '0'
								ORDER BY lst");	
$spentCredit = $dbh->getRow("SELECT SUM(amount) AS amount FROM CreditCard");			  													 				    
/* ---------------------------------------------------------------------
 * ------------------ END DATABASE CONNECTIONS ----------------------- 
 * ---------------------------------------------------------------------
 */
...
<html><!-- InstanceBegin template="/Templates/vnmain.dwt.php" codeOutsideHTMLIsLocked="false" -->
  ...
  <!-- InstanceBeginEditable name="head" -->
	<link type="text/css" rel="stylesheet" src="/Common/js/yahoo/fonts/fonts.css">
	<link type="text/css" rel="stylesheet" src="/Common/js/yahoo/reset/reset.css">
	<link type="text/css" rel="stylesheet" src="/Common/js/yahoo/calendar/assets/calendar2.css">
	...
	<script type="text/javascript" src="/Common/js/yahoo/calendar/calendar.js" ></script>
	<script type="text/javascript" src="/Common/js/yahoo/calendar/calendar-cfg.js" ></script> 
                              ...
                              <tr>
                                <td class="BGAccentVeryDarkBorder"><table width="100%"  border="0">
                                    <tr>
                                      <td colspan="2"><div id="hotMessage">
										  ...
										  <div id="hotMessageWarning" style="display:none">
												...
												<br>
												Not for  general Requisitions!</div>
                                      </div></td>
                                    </tr>
                                    <tr>
                                      <td colspan="2"><div id="privateMessage">Private Requisition: 
                                        <select name="private" id="private" onChange="$('privateMessageWarning').toggle();">
                                        <option value="no" selected>No</option>
                                        <option value="yes">Yes</option>
                                        </select>
									  	<div id="privateMessageWarning" style="display:none">
												This option should only be used on very importent<br> 
											    Requisitions that need to be looked at ASAP.<br>
											    <br>
												This option will email the first Approver and Purchasing.<br>
												<br>
									  			Not for  general Requisitions!</div></div></td>
                                    </tr>
                                    <tr>
                                      <td colspan="2"><div id="paymentMessage">Credit Card Purchase:
                                        <select name="creditCard" id="creditCard" onChange="$('paymentMessageWarning').toggle();" <?= ($_SESSION['supplier'] == 'cc') ? disabled : ''; ?>>
                                              <option value="no">No</option>
                                              <option value="yes" <?= ($_SESSION['supplier'] == 'cc') ? selected : ''; ?>>Yes</option>
                                            </select>
                                            <div id="paymentMessageWarning" style="display:<?= ($_SESSION['supplier'] == 'cc') ? display : none; ?>">
											  Credit Card purchases first have to be approved <br>
                                              by the Plant Controller.<br>
                                              <br>
                                              Total Credit Limit: $<span id="creditLimit"><?= number_format($default['creditLimit'], 2, '.', ','); ?></span><br>
                                              Available Credit: $<span id="creditAvailable"><?= number_format($default['creditLimit'] - $spentCredit['amount'], 2, '.', ','); ?></span>                                            </div>
                                      </div></td>
                                    </tr>																	
                                    <tr>
                                    ...
                                    <tr>
                                      ...
                                      <td><input name="job" type="text" id="job" size="15" maxlength="15"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                      ...
                                      <td><div>
									   <input id="id_calendar_date_1" type="text" value="" ></input>
									   <!--<a id="id_calendar_button_1" href="javascript:YAHOO.example.cal_simple.showCalendar(1);" class="id_calendar_button">--> 
										 <img src="/Common/images/calendar.gif" width="19" height="19" border="0" align="absmiddle"></a>
									  <div id="id_cal1Container_1" class="id_callContainer"></div>
									  </div></td>
                                    </tr>
                                    <tr>
                                      <td nowrap><vllabel form="Form" validators="purpose" class="valRequired2" errclass="valError">Purpose / Usage:</vllabel></td>
                                      <td><input name="purpose" type="text" id="purpose" size="75" maxlength="100">
                                    ...
                                    <tr>
                                      ...
                                      <td><textarea name="comment" cols="50" rows="7" id="comment"></textarea></td>
                                    </tr>
                                    <tr>
...
<tr>
                                      <td class="valNone">Blanket Purchase:&nbsp;</td>
                                      <td><select name="blanket" id="blanket">
                                          <option value="0">Select One</option>
                                          <?php
                                      ...
                                      <a href="blanket_list.php" <?php help('', 'Click here to get a list of approved Capital Expenditure Requests', 'default'); ?> rel="gb_page_fs[]"><img src="../images/detail.gif" width="18" height="20" border="0" align="absmiddle"></a></td>
                                  </tr>									
                                    <tr>
