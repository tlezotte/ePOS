...
if ($_SESSION['beta'] == 'on') {
	header("Location: list_beta.php?".$_SERVER['QUERY_STRING']);
	exit();
}
/**
...
/* SQL for PO list */
$po_sql = "SELECT p.id, p.po, p.hot, p.purpose, p.reqDate, p.req, p.sup, p.total, p.plant, a.controller, a.app1, a.app1Date, a.app2, a.app2Date, a.app3, a.app3Date, a.app4, a.app4Date, a.issuer, a.issuerDate, p.status, a.level
						 FROM PO p
                          ...
                          <div align="right">Status View:
                            <input name="action" type="hidden" id="action" value="<?= $_GET['action']; ?>">
                              ...
                              <select name="status" id="status" onChange="this.form.submit();">
                                ...
                                <option value="O">Vendor Kickoff</option>
                            ...
                            <tr>
                              <td><table width="100%"  border="0">
                                <tr>
								  ...
								  <?php } ?>
								  <?php } ?>
								  <?php if (($_SESSION['request_role'] == 'purchasing' AND $_GET['status'] == 'A') OR $_SESSION['request_role'] == 'executive') { ?>
