    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" summary="">
      <tbody>
        <tr>
          ...
          <!-- InstanceBeginEditable name="topRightMenu" --><?php if ($_SESSION['request_access'] >= 2) { ?><a href="<?= $default['URL_HOME']; ?>/PO/detail_yui2.php?<?= $_SERVER['QUERY_STRING']; ?>" class="DarkHeaderSubSub"><img src="../images/newred.gif" width="34" height="15" border="0">Switch to Beta</a><?php } ?><!-- InstanceEndEditable --></td>
        </tr>
