                            ...
                            <tr>
                              <td><form action="<?= $_SERVER['PHP_SELF']; ?>" method="post" name="Form" id="Form" runat="vdaemon">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  ...
                                  <tr>
                                    <td align="center" class="BGAccentDarkBorder"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td width="75%">&nbsp;Items: <span style="font-weight:bold; font-size:16px" id="totalItems">1</span></td>
                                        <td align="center">Total: <span style="font-weight:bold; font-size:20px" id="totalAmount">$0.00</span></td>
                                      </tr>
                                    </table>
                                    </td>
                                  </tr>
