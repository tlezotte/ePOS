                                  ...
                                  <tr>
                                    <td class="BGAccentVeryDarkBorder"><table width="100%"  border="0">
                                        ...
                                        <tr class="BGAccentLight">
                                          ...
                                          <td><input name="price<?= $items; ?>" type="text" id="price<?= $items; ?>" size="10" maxlength="17" value="<?= $price; ?>" onBlur="Calculate();"></td>
									    ...
									    <td colspan="3"><input name="total" type="text" id="total" size="10" maxlength="17" value="<?= $_SESSION['total']; ?>" readonly>
