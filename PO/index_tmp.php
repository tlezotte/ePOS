...
/* Get My Suppliers */
$mySuppliers_sql = $dbh->prepare("SELECT DISTINCT s.BTVEND AS id, CONCAT(s.BTNAME, ' ( ', s.BTVEND, ' )') AS name, s.BTADR1 AS address, s.BTADR3 AS city, s.BTPRCD AS state, s.BTPOST AS zip5
...
if ($_POST['action'] == "search") {
	...
	$suppliers_sql = "SELECT BTVEND AS id, CONCAT(BTNAME, ' ( ', BTVEND, ' )') AS name, BTADR1 AS address, BTADR3 AS city, BTPRCD AS state, BTPOST AS zip5
                            ...
                            <tr>
                              <td height="30" valign="top">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td valign="bottom"><span class="DarkHeaderSubSub">&nbsp;&nbsp;<a href="javascript:void();" <?php help('', 'View the list of Your Company Prefered Vendors', 'default'); ?>  onclick="return GB_showFullScreen('Prefered Vendors List', 'preferred.php')" class="DarkHeaderSubSub"><img src="../images/notes.gif" width="12" height="15" border="0" align="texttop">Preferred Vendor List</a></span></td>
                                ...
                                <table width="50%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  ...
                                  <tr>
                                    <td class="BGAccentVeryDarkBorder"><table width="885" border="0">
                                        <tr class="blueItem">
                                          <td class="padding"><input  name="supplier" type="radio" value="cc" <?php if ($_SESSION['supplier'] == $SUPPLIER['id']) { echo "checked"; } ?>></td>                                         
                                            <td colspan="5" class="padding">Credit Card Purchase -- VENDOR NOT LISTED </td>
                                        </tr>
                                        <tr class="blueItem">
                                          <td class="padding"><input  name="supplier" type="radio" value="purchasing" <?php if ($_SESSION['supplier'] == $SUPPLIER['id']) { echo "checked"; } ?>></td>
                                            <td colspan="5" class="padding">Have Purchasing select the Vendor</td>
                                        </tr>
                                        <tr>
                                          <td height="10" colspan="6" class="padding"><img src="../images/spacer.gif" width="5" height="10"></td>
                                        </tr>									
                                        <tr>
                                        ...
                                        <tr <?php pointer($row_color); ?>>
                                          ...
                                          <td nowrap bgcolor="#<?= $row_color; ?>" class="padding"><a href="javascript:void(0);"  <?php help('', 'Click here to view information for '.ucwords(strtolower($SUPPLIER[name])).'', 'default'); ?> onclick="return GB_show('Vendor Details', '../Administration/vendor_details.php?id=<?= $SUPPLIER[id]; ?>', 511, 400)"><img src="../images/detail.gif" width="18" height="20" border="0" align="absmiddle"></a>&nbsp;<?= caps($SUPPLIER['name']); ?></td>
                                          <td nowrap bgcolor="#<?= $row_color; ?>" class="padding">
										  <?php if (strlen($SUPPLIER['address']) > 0) { ?>
										  <a href="javascript:void(0);" onclick="return GB_show('Vendor Location', 'http://maps.google.com/maps?q=<?= $SUPPLIER['address']; ?> <?= $SUPPLIER['city']; ?>, <?= $SUPPLIER['state']; ?> <?= $SUPPLIER['zip5']; ?>&om=1', 600, 600)"><img src="/Common/images/map.gif" width="20" height="20" border="0" align="absmiddle" <?php help('', "Get a map showing ".ucwords(strtolower($SUPPLIER['name']))."\'s location", 'default'); ?>></a>
										  <?php } ?>
