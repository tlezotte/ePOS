...
<!-- #EndLibraryItem --><!-- InstanceEndEditable --></td>
	...
	<?php 
	  if ($_SESSION['request_access'] == '3') {
		...
		echo "&nbsp;<img src=\"/Common/images/adminSQLAction.gif\" onClick=\"new Effect.toggle('historyPanel', 'slide')\">";
		
	    include('../Administration/include/detail.php');
		echo "<div  id='historyPanel' style='display:none'></div>";
	  } 
	?>
...
<!-- End of Item<?= $count_items; ?> -->
                                    ...
                                    <tr>
                                      <td height="25" class="BGAccentDarkBlue"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          ...
                                          <td align="right"><a href="javascript:void(0);"  <?php help('Last Updated', date('\D\a\y\:  F d, Y \<\b\r\>\T\i\m\e\: H:i:s', strtotime($PO['update_status'])), 'default'); ?> class="LightHeaderSubSub"><?php if (!empty($PO['purchaseUpdate'])) { ?>Last Updated: <?= date('F d, Y', strtotime($PO['update_status'])); ?></a><?php } ?></td>
                                        </tr>
                                      </table></td>
                                    </tr>
                                    <tr>
                                      <td><table width="100%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
										  ...
										  <?php if (is_null($PO['po']) AND $PO['status'] == 'A') { ?>
                                            <div id="approvalTime">
                                            Time elapsed since Requisition approval: <strong><?= elapsedApprovalTime($_GET['id']); ?> hours</strong>
                                            </div>
                                          <?php } ?>                                             
                                          <div id="purchasingTabMenu" class="yui-navset">
                                                ...
                                                <div class="yui-content">
                                                        ...
                                                        <table width="100%" border="0" cellspacing="5" cellpadding="0" id="purchasingInfo">
                                                          <tr>
                                                            <td colspan="4" class="blueNoteArea">
																Purchase Order Number: <input name="po" type="text" id="po" value="<?= $PO['po']; ?>" size="10" maxlength="7">
                                                                <?php if (empty($PO['po'])) { ?>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td colspan="3" class="label"><input id="vendSearch" name="vendSearch" type="text" size="50" />
                                                              ...
                                                              <input name="supplierNewTerms" type="hidden" id="supplierNewTerms" /></td></tr>
                                                          <tr>
                                                            <td>&nbsp;</td>
                                                            <td>&nbsp;</td>
                                                            <td>&nbsp;</td>
                                                    ...
                                                    <div id="Contacts">
                                                    	<!-- ===================== START CONTACTS TAB ===================== -->
                                                    	<center><div id="contactsXML"></div></center>
                                                    	<!-- ===================== END CONTACTS TAB ===================== -->
                                                    </div>
                                                    <div id="SendPO">
                                                    	<!-- ===================== START SEND PURCHASE ORDER TAB ===================== -->
                                                    	<center><div id="sendPoXML"></div></center>
  ...
  <!-- InstanceBeginEditable name="js" -->
    ...
    <script type="text/javascript" src="/Common/js/yahoo/yahoo-dom-event/yahoo-dom-event.js" ></script>
