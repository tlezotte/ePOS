...
<!-- #EndLibraryItem --><!-- InstanceEndEditable --></td>
        ...
        <tr>
          <td valign="bottom" align="right" colspan="2"><!-- InstanceBeginEditable name="rightMenu" --><?php include('../../include/menu/right.php'); ?><!-- InstanceEndEditable --></td>
  ...
  <tr>
    ...
    <td valign="top"><div align="center">
		<br>		
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top" class="BGAccentDarkBorderWhite"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
              ...
              <tr>
                ...
                <td valign="top" class="BGAccentDarkBorderWhite"><!--<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td class="xpHeaderTop"><div class="ApplicationSwitcherText">Top 10 between
                      <?= $startFull; ?>
                      and
                      <?= $endFull; ?>
                    </div></td>
                  ...
                  <tr>
                    <td align="center"><a href="transactions.php?<?= $_SERVER['QUERY_STRING']; ?>" <?php help('', 'Display detailed view for Transactions', 'default'); ?>><img src="transactions_bar.php?start=<?=$start?>&end=<?=$end?>" border="0"></a></td>
                  </tr>
                </table>--></td>
              </tr>
            </table>
