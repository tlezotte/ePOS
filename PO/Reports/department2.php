...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0','width','500','height','350','id','charts','align','','src','/Common/Javascript/maani/charts?library_path=/Common/Javascript/maani/charts_library&xml_source=test.php%3Ft%3D<?= $_GET['t']; ?>','quality','high','wmode','transparent','name','charts','swliveconnect','true','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','/Common/Javascript/maani/charts?library_path=/Common/Javascript/maani/charts_library&xml_source=test.php%3Ft%3D<?= $_GET['t']; ?>' ); //end AC code
                        ...
                        id="charts" 
                        ALIGN="">
                            <PARAM NAME=movie VALUE="/Common/Javascript/maani/charts.swf?library_path=/Common/Javascript/maani/charts_library&xml_source=test.php%3Ft%3D<?= $_GET['t']; ?>">
                              <PARAM NAME=quality VALUE=high>
                              <param name="wmode" value="transparent">
                            <EMBED src="/Common/Javascript/maani/charts.swf?library_path=/Common/Javascript/maani/charts_library&xml_source=test.php%3Ft%3D<?= $_GET['t']; ?>" 
                           quality=high 
                           wmode="transparent"  
                           WIDTH="500" 
                           HEIGHT="350" 
              ...
              <tr>
                <td><table width="100%" class="BGAccentDarkBorder" style="filter:alpha(opacity=50);-moz-opacity:.50;opacity:.50;">
                    <tr>
                      <td align="center"><a href="<?= $_SERVER['PHP_SELF']; ?>?t=column"><img src="/Common/images/bar_chart.gif" alt="Bar Chart" width="38" height="35" border="0"></a></td>
                      <td align="center"><a href="<?= $_SERVER['PHP_SELF']; ?>?t=bar"><img src="/Common/images/horizBar_chart.gif" alt="Horizontal Bar Chart" width="38" height="35" border="0"></a></td>
                      <td align="center"><a href="<?= $_SERVER['PHP_SELF']; ?>?t=stacked"><img src="/Common/images/stacked_bar_chart.gif" alt="Stacked Bar Chart" width="38" height="35" border="0"></a></td>
                      <td align="center"><a href="<?= $_SERVER['PHP_SELF']; ?>?t=area"><img src="/Common/images/area_chart.gif" alt="Area Chart" width="38" height="35" border="0"></a></td>
                      <td align="center"><a href="<?= $_SERVER['PHP_SELF']; ?>?t=line"><img src="/Common/images/line_chart.gif" alt="Line Chart" width="38" height="35" border="0"></a></td>
                      <td align="center"><a href="<?= $_SERVER['PHP_SELF']; ?>?t=polar"><img src="/Common/images/radar_chart.gif" alt="Radar Chart" width="38" height="35" border="0"></a></td>
                    </tr>
                  </table></td>
              </tr>
            </table>
