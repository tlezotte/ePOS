    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" summary="">
      <tbody>
        <tr>
          ...
          <!-- TemplateBeginEditable name="topRightMenu" -->
        ...
        <tr>
          <td valign="bottom" align="right" colspan="2"><!-- TemplateBeginEditable name="rightMenu" --><?php include('../include/menu/main_right.php'); ?><!-- TemplateEndEditable --></td>
          ...
          <td width="100%" colspan="3"><table cellspacing="0" cellpadding="0" width="100%" summary="" border="0">
            <tbody>
              ...
              <tr>
                ...
                <td class="BGColorDark" rowspan="3"><!-- TemplateBeginEditable name="leftMenu" --><!-- #BeginLibraryItem "/Library/lm_Spacer.lbi" --><table cellspacing="0" cellpadding="0" summary="" border="0">
	<tr>
...
<!-- #EndLibraryItem --><!-- TemplateEndEditable --></td>
    ...
    <!-- TemplateBeginEditable name="main" --><!-- TemplateEndEditable --><br>
    <br>
        ...
        <tr>
          <td width="100%" height="20" class="BGAccentDark">
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50%"><span class="Copyright"><!-- TemplateBeginEditable name="copyright" --><?php include('../include/copyright.php'); ?><!-- TemplateEndEditable --></span></td>
                <td width="50%"><div id="noPrint" align="right"><!-- TemplateBeginEditable name="version" --><!-- TemplateEndEditable --></div></td>
              </tr>
            </table></td>
        </tr>
        <tr>
          <td>
		  <div align="center"><!-- TemplateBeginEditable name="footer" --><!-- TemplateEndEditable --></div>
  ...
  <!-- TemplateBeginEditable name="js" --><!-- TemplateEndEditable -->   
</html>
