 ...
 * Request System
 *
 * error.php display any error for project.
 *
 * @version 1.5
...
<!-- #EndLibraryItem --><!-- InstanceEndEditable --></td>
    ...
    <table width="50%"  border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center"><span class="DarkHeaderSubSub"><?= $default['title0']; ?></span><br>
      ...
      <tr>
        <td class="ErrorNameText"><div align="center"><?= $_SESSION['error']; ?></div></td>
      </tr>
	  <tr>
        <td height="25">&nbsp;</td>
      </tr>
	  <tr>
	    <td align="center"><a href="javascript:history.go(-1)"><img src="images/button.php?i=b70.png&l=Back" border="0"></a></td>
      </tr>
	  <tr>
	    <td height="35" align="center" class="DarkHeaderSubSub">OR</td>
      </tr>
	  <tr>
	    <td align="center"><a href="<?= $default['URL_HOME']; ?>"><img src="images/button.php?i=b110.png&l=Return Home" border="0"></a></td>
      </tr>
    </table>
