...
<html><!-- InstanceBegin template="/Templates/vnmain.dwt.php" codeOutsideHTMLIsLocked="false" -->
  ...
  <!-- InstanceBeginEditable name="head" -->
	...
	<script>
		url = "PO/requisitions_xml.php?action=my&access=0";
		
		var dsRequests = new Spry.Data.XMLDataSet(url, "requisitions/requisition", {sortOnLoad:"id", sortOrderOnLoad:"descending"});
		dsRequests.setColumnType("id", "number");
		dsRequests.setColumnType("requester/@date", "date");
	
		<?php getProxyDATA("http://intranet.Company.com/?q=taxonomy/term/27/0/feed", "intranet_request.xml"); ?>
	
		var dsChangeLog = new Spry.Data.XMLDataSet("proxy/intranet_request.xml", "rss/channel/item", {sortOnLoad:"pubDate", sortOrderOnLoad:"descending"});
		dsChangeLog.setColumnType("pubDate", "date");	
...
<!-- #EndLibraryItem --><!-- InstanceEndEditable --></td>
    ...
    <div align="center">	
      <table width="100%"  border="0" cellspacing="0" cellpadding="0" id="HomePage">
        <tr>
          <td width="300" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" id="openRequisitions">
            <tr>
              <td height="25" valign="middle" class="BGAccentVeryDark ColorHeaderSubSub">&nbsp;&nbsp;<strong>Open Requisitions</strong></td>
            </tr>
            <tr>
              <td class="BGAccentVeryDarkBorder"><div spry:region="dsRequests" class="SpryHiddenRegion">
                  <div class="spryReadySmall" spry:state="ready" spry:if="{ds_RowCount} == 0">No requests found.</div>
                <div class="spryLoadingSmall" spry:state="loading">Loading requests...</div>
                <div class="spryFailedSmall" spry:state="error">Failed to load requests...</div>
                <div spry:repeat="dsRequests" spry:even="spryOdd" spry:odd="spryEven" spry:hover="spryHover"> <a href="Requests/detail.php?id={id}" class="dark">{id} <img src="/Common/images/{level}.gif" width="19" height="16" align="absmiddle" border="0" /> {position/title}</a> </div>
              </div></td>
            </tr>
          </table>
          <?php 
          ...
          <td width="300" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" id="releaseNotes">
            <tr>
              <td height="25" valign="middle" class="BGAccentVeryDark ColorHeaderSubSub">&nbsp;&nbsp;<strong>Changes Log</strong></td>
            </tr>
            <tr>
              <td class="BGAccentVeryDarkBorder"><div spry:region="dsChangeLog" class="SpryHiddenRegion">
                  <div class="spryReadySmall" spry:state="ready" spry:if="{ds_RowCount} == 0">No changes found.</div>
                <div class="spryLoadingSmall" spry:state="loading">Loading changes...</div>
                <div class="spryFailedSmall" spry:state="error">Failed to load changes...</div>
                <div spry:repeat="dsChangeLog" spry:even="spryOdd" spry:odd="spryEven" spry:hover="spryHover"> <a href="{link}" title="{pubDate}" onClick="displayChangeLog('on');" class="dark" target="ChangeLog">{title}</a> <a href="{link}" title="Open in new window or tab" target="log"><img src="/Common/images/offsite.gif" border="0"></a> </div>
              </div></td>
            </tr>
          </table></td>
        </tr>
