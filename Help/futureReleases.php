 ...
 * Request System
 *
 * futureReleases.php features that will be added.
 *
 * @version 1.5
...
<html><!-- InstanceBegin template="/Templates/vnmain.dwt.php" codeOutsideHTMLIsLocked="false" -->
  ...
  <body class="yui-skin-sam">  
                      ...
                      <tr>
                        ...
                        <td><table cellspacing="0" cellpadding="0" summary="" border="0">
                            <tr>
							  ...
							  -->
                              <td nowrap><a href="PO/releasenotes.php" class="off">Purchase Order</a></td>
                              <!--
							  <td width="20" valign="middle" nowrap><div align="center"><img src="../images/dot.gif" width="10" height="10"></div></td>
    ...
    <table  border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td class="BGAccentDarkBorder"><table  border="0" cellspacing="1">
          <tr>
            <td height="30" class="BGAccentVeryDark">&nbsp;&nbsp;Feature Description</td>
            <td nowrap class="BGAccentVeryDark"><div align="center">Capital Acquisition </div></td>
            <td nowrap class="BGAccentVeryDark"><div align="center">Requisition </div></td>
            <td nowrap class="BGAccentVeryDark">Administration</td>
          </tr>
          <tr bgcolor="DFDFBF">
            <td><strong>&nbsp;&nbsp;Vacation</strong></td>
            <td><div align="center"><img src="../images/change.png" width="17" height="17" border="0"></div></td>
            <td><div align="center"><img src="../images/change.png" width="17" height="17" border="0"></div></td>
            <td><div align="center"><img src="../images/nochange.png" alt="Not Applicable" width="17" height="17" border="0"></div></td>
          </tr>
          <tr bgcolor="DFDFBF">
            <td><blockquote> Set employee to receive Requests while you are on vacation</blockquote></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr class="odd">
            <td><strong>&nbsp;&nbsp;Reports and Charts</strong></td>
            <td><div align="center"><img src="../images/change.png" width="17" height="17" border="0"></div></td>
            <td><div align="center"><img src="../images/okay.png" alt="In Current Version" width="17" height="17"></div></td>
            <td><div align="center"><img src="../images/change.png" width="17" height="17" border="0"></div></td>
          </tr>
          <tr class="odd">
            <td><blockquote> Generate reports and/or charts for different components </blockquote></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          ...
          <tr bgcolor="DFDFBF">
            <td><blockquote> Search for a Request by specific parameters</blockquote></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          ...
          <tr>
            <td><blockquote> The ability to modify Requests after submission</blockquote></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr bgcolor="DFDFBF">
            <td><strong>&nbsp;&nbsp;Automatic Notifier</strong></td>
            <td><div align="center"><img src="../images/change.png" width="17" height="17" border="0"></div></td>
            <td><div align="center"><img src="../images/okay.png" alt="In Current Version" width="17" height="17"></div></td>
            <td><div align="center"><img src="../images/nochange.png" alt="Not Applicable" width="17" height="17" border="0"></div></td>
          </tr>
          <tr bgcolor="DFDFBF">
            <td><blockquote> Automatically notify approvers that they have an outstanding Request </blockquote></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          ...
          <tr>
            <td><blockquote> On Hold will allow an approver to but a Request on hold </blockquote></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
