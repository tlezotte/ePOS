...
function Header()
{
	$this->Image('http://www.yourdomain.com/Common/images/Company.jpg',5,5);	//Print Deluxe Logo
	$this->SetFont('Arial','',10);		//Set Font: Type, Size
	$this->SetY(30);
	$this->Cell(00,5,'Your Company',0,1,'C');				//Company Address
	$this->Cell(00,5,'6555 15 Mile Rd',0,1,'C');				//Company Address
	$this->Cell(00,5,'Sterling Heights, MI 48312',0,1,'C');				//Company Address
}
}
