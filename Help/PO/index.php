 ...
 * Request System
 *
 * index.php main page for PO Help.
 *
 * @version 1.5
                      ...
                      <tr>
                        ...
                        <td><table cellspacing="0" cellpadding="0" summary="" border="0">
                            <tr>
							  ...
							  -->
                              <td nowrap><a href="index.php" class="off">Purchase Order</a></td>
                              <!--
							  <td width="20" valign="middle" nowrap><div align="center"><img src="../images/dot.gif" width="10" height="10"></div></td>
            ...
            <tr>
              ...
              <td valign="top" width="165" bgcolor="#cccc99"><img height="1" alt="" src="../../images/asybase.gif" width="145" border="0"> <br>
                  <table width="100%" border="0" cellspacing="0" cellpadding="1" rules="rows">
                    <tr>
                      <td class="mainsection"><a href="FeaturesOverview.php" class="dark">Overview</a></td>
                    </tr>
                </table>
				  <table width="100%" border="0" cellspacing="0" cellpadding="1" rules="rows">
                    <tr>
                      <td class="mainsection"><a href="CreatePurchaseOrder.php" class="dark">Create a Requisition </a></td>
                    </tr>
                  </table>
			      <table width="100%" border="0" cellspacing="0" cellpadding="1" rules="rows">
                    <tr>
                      <td class="mainsection"><a href="ListPurchaseOrders.php" class="dark">List Purchase Request </a></td>
                    </tr>
                  </table>
				  <!--
		          <table width="100%" border="0" cellspacing="0" cellpadding="1" rules="rows">
